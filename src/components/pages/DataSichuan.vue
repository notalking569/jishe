...
<header class="dashboard-header">
  ...
  <p><strong>四诊合参：</strong> {{ caseDetails[selectedCase][currentImageIndex].summary }}</p>
    ...
    <h3>川人体质调理建议</h3>
    <p>根据古籍《素问·上古天真论》和《类经·藏象类》的记载，结合巴蜀地区名医的经验，川人体质调理可以从以下几方面入手：</p>
    <ul>
        <li>
            <strong>饮食调理：</strong>
            <ul>
                <li>减少辛辣、油腻食物的摄入，避免过度刺激肠胃。</li>
                <li>多吃健脾祛湿的食物，如薏苡仁、赤小豆、山药、冬瓜等，有助于改善湿热体质。</li>
                <li>遵循《素问》中“五谷为养，五果为助，五畜为益，五菜为充”的饮食原则，保持饮食均衡。</li>
                <li>适量饮用绿茶或菊花茶，有助于清热解毒。</li>
            </ul>
        </li>
          </ul>
</div>
...
const caseDetails = [
  [
    ...
    {
      symptom: '舌质淡白，边缘齿痕，气血双虚。舌质淡白可能意味着心血虚，边缘齿痕则可能是脾虚湿盛的表现，这些都是气血不足的信号，可能伴有乏力、头晕、心悸等症状。',
      constitution: '川人体质多脾虚，望诊易见舌质淡白、齿痕明显。这与地区饮食习惯和生活方式有关，如饮食不规律、过度劳累等，需要通过饮食和生活习惯的调整来改善。',
      summary: '四诊提示气血两虚，兼脾气虚弱，应补气养血。建议采用补气养血的治疗方法，如服用当归、黄芪等中药材，同时增加营养摄入，改善生活习惯，保证充足的休息和适当的运动。'
    },
    {
      symptom: '舌裂纹，津液亏损。舌裂纹可能是由于体内津液不足，无法滋养舌面所致，这在中医中被视为阴虚的表现，可能伴有口干、咽干、便秘等症状。',
